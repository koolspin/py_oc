...
def init_element_list(universe: Universe) -> None:
    ...
    universe.MakeElement(17, 35.453, "Cl", "Chlorine", 3, 17, "1s^2 2s^2 2p^6 3s^2 3p^5")

    # elt = Element(18, 39.948, "Ar", "Argon", 3, 18, "1s^2 2s^2 2p^6 3s^2 3p^6", None)
    universe.MakeElement(18, 39.948, "Ar", "Argon", 3, 18, "1s^2 2s^2 2p^6 3s^2 3p^6")

    # Period 4
    # elt = Element(19, 39.098, "K", "Potassium", 4, 1, "1s^2 2s^2 2p^6 3s^2 3p^6 4s^1", None)
    universe.MakeElement(19, 39.098, "K", "Potassium", 4, 1, "1s^2 2s^2 2p^6 3s^2 3p^6 4s^1")

    # elt = Element(20, 40.078, "Ca", "Calcium", 4, 2, "1s^2 2s^2 2p^6 3s^2 3p^6 4s^2", None)
    universe.MakeElement(20, 40.078, "Ca", "Calcium", 4, 2, "1s^2 2s^2 2p^6 3s^2 3p^6 4s^2")

    # elt = Element(21, 44.956, "Sc", "Scandium", 4, 3, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^1 4s^2", None)
    universe.MakeElement(21, 44.956, "Sc", "Scandium", 4, 3, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^1 4s^2")

    # elt = Element(22, 47.867, "Ti", "Titanium", 4, 4, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^2 4s^2", None)
    universe.MakeElement(22, 47.867, "Ti", "Titanium", 4, 4, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^2 4s^2")

    # elt = Element(23, 50.942, "V", "Vanadium", 4, 5, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^3 4s^2", None)
    universe.MakeElement(23, 50.942, "V", "Vanadium", 4, 5, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^3 4s^2")

    # elt = Element(24, 51.996, "Cr", "Chromium", 4, 6, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^5 4s^1", None)
    universe.MakeElement(24, 51.996, "Cr", "Chromium", 4, 6, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^5 4s^1")

    # elt = Element(25, 54.938, "Mn", "Manganese", 4, 7, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^5 4s^2", None)
    universe.MakeElement(25, 54.938, "Mn", "Manganese", 4, 7, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^5 4s^2")

    # elt = Element(26, 55.845, "Fe", "Iron", 4, 8, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^6 4s^2", None)
    universe.MakeElement(26, 55.845, "Fe", "Iron", 4, 8, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^6 4s^2")

    # elt = Element(27, 58.933, "Co", "Cobalt", 4, 9, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^7 4s^2", None)
    universe.MakeElement(27, 58.933, "Co", "Cobalt", 4, 9, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^7 4s^2")

    # elt = Element(28, 58.693, "Ni", "Nickel", 4, 10, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^8 4s^2", None)
    universe.MakeElement(28, 58.693, "Ni", "Nickel", 4, 10, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^8 4s^2")

    # elt = Element(29, 63.546, "Cu", "Copper", 4, 11, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^1", None)
    universe.MakeElement(29, 63.546, "Cu", "Copper", 4, 11, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^1")

    # elt = Element(30, 65.380, "Zn", "Zinc", 4, 12, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2", None)
    universe.MakeElement(30, 65.380, "Zn", "Zinc", 4, 12, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2")

    # elt = Element(31, 69.723, "Ga", "Gallium", 4, 13, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^1", None)
    universe.MakeElement(31, 69.723, "Ga", "Gallium", 4, 13, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^1")

    # elt = Element(32, 72.640, "Ge", "Germanium", 4, 14, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^2", None)
    universe.MakeElement(32, 72.640, "Ge", "Germanium", 4, 14, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^2")

    # elt = Element(33, 74.922, "As", "Arsenic", 4, 15, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^3", None)
    universe.MakeElement(33, 74.922, "As", "Arsenic", 4, 15, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^3")

    # elt = Element(34, 78.960, "Se", "Selenium", 4, 16, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^4", None)
    universe.MakeElement(34, 78.960, "Se", "Selenium", 4, 16, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^4")

    # elt = Element(35, 79.904, "Br", "Bromine", 4, 17, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^5", None)
    universe.MakeElement(35, 79.904, "Br", "Bromine", 4, 17, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^5")

    # elt = Element(36, 83.798, "Kr", "Krypton", 4, 18, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6", None)
    universe.MakeElement(36, 83.798, "Kr", "Krypton", 4, 18, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6")

    # Period 5
    # elt = Element(37, 85.468, "Rb", "Rubidium", 5, 1, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 5s^1", None)
    universe.MakeElement(37, 85.468, "Rb", "Rubidium", 5, 1, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 5s^1")

    # elt = Element(38, 87.620, "Sr", "Strontium", 5, 2, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 5s^2", None)
    universe.MakeElement(38, 87.620, "Sr", "Strontium", 5, 2, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 5s^2")

    # elt = Element(39, 88.906, "Y", "Yttrium", 5, 3, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^1 5s^2", None)
    universe.MakeElement(39, 88.906, "Y", "Yttrium", 5, 3, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^1 5s^2")

    # elt = Element(40, 91.224, "Zr", "Zirconium", 5, 4, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^2 5s^2", None)
    universe.MakeElement(40, 91.224, "Zr", "Zirconium", 5, 4, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^2 5s^2")

    # elt = Element(41, 92.906, "Nb", "Niobium", 5, 5, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^4 5s^1", None)
    universe.MakeElement(41, 92.906, "Nb", "Niobium", 5, 5, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^4 5s^1")

    # elt = Element(42, 95.950, "Mo", "Molybdenum", 5, 6, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^5 5s^1", None)
    universe.MakeElement(42, 95.950, "Mo", "Molybdenum", 5, 6, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^5 5s^1")

    # elt = Element(43, 98.000, "Tc", "Technetium", 5, 7, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^5 5s^2", None)
    universe.MakeElement(43, 98.000, "Tc", "Technetium", 5, 7, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^5 5s^2")

    # elt = Element(44, 101.070, "Ru", "Ruthenium", 5, 8, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^7 5s^1", None)
    universe.MakeElement(44, 101.070, "Ru", "Ruthenium", 5, 8, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^7 5s^1")

    # elt = Element(45, 102.910, "Rh", "Rhodium", 5, 9, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^8 5s^1", None)
    universe.MakeElement(45, 102.910, "Rh", "Rhodium", 5, 9, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^8 5s^1")

    # elt = Element(46, 106.420, "Pd", "Palladium", 5, 10, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10", None)
    universe.MakeElement(46, 106.420, "Pd", "Palladium", 5, 10, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10")

    # elt = Element(47, 107.870, "Ag", "Silver", 5, 11, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^1", None)
    universe.MakeElement(47, 107.870, "Ag", "Silver", 5, 11, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^1")

    # elt = Element(48, 112.410, "Cd", "Cadmium", 5, 12, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2", None)
    universe.MakeElement(48, 112.410, "Cd", "Cadmium", 5, 12, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2")

    # elt = Element(49, 114.820, "In", "Indium", 5, 13, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^1", None)
    universe.MakeElement(49, 114.820, "In", "Indium", 5, 13, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^1")

    # elt = Element(50, 118.710, "Sn", "Tin", 5, 14, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^2", None)
    universe.MakeElement(50, 118.710, "Sn", "Tin", 5, 14, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^2")

    # elt = Element(51, 121.760, "Sb", "Antimony", 5, 15, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^3",
    #               None)
    universe.MakeElement(51, 121.760, "Sb", "Antimony", 5, 15, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^3")

    # elt = Element(52, 127.600, "Te", "Tellerium", 5, 16, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^4",
    #               None)
    universe.MakeElement(52, 127.600, "Te", "Tellerium", 5, 16, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^4")

    # elt = Element(53, 126.900, "I", "Iodine", 5, 17, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^5", None)
    universe.MakeElement(53, 126.900, "I", "Iodine", 5, 17, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^5")

    # elt = Element(54, 131.290, "Xe", "Xenon", 5, 18, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^6", None)
    universe.MakeElement(54, 131.290, "Xe", "Xenon", 5, 18, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^6")

    # Period 6
    # elt = Element(55, 132.910, "Cs", "Caesium", 6, 1, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^6 6s^1",
    #               None)
    universe.MakeElement(55, 132.910, "Cs", "Caesium", 6, 1, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^6 6s^1")

    # elt = Element(56, 137.330, "Ba", "Barium", 6, 2, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^6 6s^2",
    #               None)
    universe.MakeElement(56, 137.330, "Ba", "Barium", 6, 2, "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^6 6s^2")

    # elt = Element(57, 138.910, "La", "Lanthanum", 6, 3,
    #               "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 5s^2 5p^6 5d^1 6s^2", None)
    universe.MakeElement(57, 138.910, "La", "Lanthanum", 6, 3,
    ...
    universe.MakeElement(72, 178.490, "Hf", "Hafnium", 6, 4,
    ...
    universe.MakeElement(73, 180.950, "Ta", "Tantalum", 6, 5,
    ...
    universe.MakeElement(74, 183.840, "W", "Tungsten", 6, 6,
    ...
    universe.MakeElement(75, 186.210, "Re", "Rhenium", 6, 7,
    ...
    universe.MakeElement(76, 190.230, "Os", "Osmium", 6, 8,
    ...
    universe.MakeElement(77, 192.220, "Ir", "Iridium", 6, 9,
    ...
    universe.MakeElement(78, 195.080, "Pt", "Platinum", 6, 10,
    ...
    universe.MakeElement(79, 196.970, "Au", "Gold", 6, 11,
    ...
    universe.MakeElement(80, 200.590, "Hg", "Mercury", 6, 12,
    ...
    universe.MakeElement(81, 204.380, "Tl", "Thalium", 6, 13,
    ...
    universe.MakeElement(82, 207.200, "Pb", "Lead", 6, 14,
    ...
    universe.MakeElement(83, 208.980, "Bi", "Bismuth", 6, 15,
    ...
    universe.MakeElement(84, 209.000, "Po", "Polonium", 6, 16,
    ...
    universe.MakeElement(85, 210.000, "At", "Astatine", 6, 17,
    ...
    universe.MakeElement(86, 222.000, "Rn", "Radon", 6, 18,
    ...
    universe.MakeElement(87, 223.000, "Fr", "Francium", 7, 1,
    ...
    universe.MakeElement(88, 226.000, "Ra", "Radium", 7, 2,
    ...
    universe.MakeElement(89, 227.000, "Ac", "Actinium", 7, 3,
    ...
    #               None)
    universe.MakeElement(104, 267.000, "Rf", "Rutherfordium", 7, 4,
                  "1s^2 2s^2 2p^6 3s^2 3p^6 3d^10 4s^2 4p^6 4d^10 4f^14 5s^2 5p^6 5d^10 5f^14 6s^2 6p^6 6d^2 7s^2")

    # elt = Element(105, 262.000, "Db", "Dubnium", 7, 5, "", None)
    universe.MakeElement(105, 262.000, "Db", "Dubnium", 7, 5, "")

    # elt = Element(106, 269.000, "Sg", "Seaborgium", 7, 6, "", None)
    universe.MakeElement(106, 269.000, "Sg", "Seaborgium", 7, 6, "")

    # elt = Element(107, 264.000, "Bh", "Bohrium", 7, 7, "", None)
    universe.MakeElement(107, 264.000, "Bh", "Bohrium", 7, 7, "")

    # elt = Element(108, 269.000, "Hs", "Hassium", 7, 8, "", None)
    universe.MakeElement(108, 269.000, "Hs", "Hassium", 7, 8, "")

    # elt = Element(109, 278.000, "Mt", "Meitnerium", 7, 9, "", None)
    universe.MakeElement(109, 278.000, "Mt", "Meitnerium", 7, 9, "")

    # elt = Element(110, 281.000, "Ds", "Darmstadtium", 7, 10, "", None)
    universe.MakeElement(110, 281.000, "Ds", "Darmstadtium", 7, 10, "")

    # elt = Element(111, 282.000, "Rg", "Roentgenium", 7, 11, "", None)
    universe.MakeElement(111, 282.000, "Rg", "Roentgenium", 7, 11, "")

    # elt = Element(112, 285.000, "Cn", "Copernicium", 7, 12, "", None)
    universe.MakeElement(112, 285.000, "Cn", "Copernicium", 7, 12, "")

    # elt = Element(113, 286.000, "Nh", "Nihonium", 7, 13, "", None)
    universe.MakeElement(113, 286.000, "Nh", "Nihonium", 7, 13, "")

    # elt = Element(114, 289.000, "Fl", "Flerovium", 7, 14, "", None)
    universe.MakeElement(114, 289.000, "Fl", "Flerovium", 7, 14, "")

    # elt = Element(115, 289.000, "Mc", "Moscovium", 7, 15, "", None)
    universe.MakeElement(115, 289.000, "Mc", "Moscovium", 7, 15, "")

    # elt = Element(116, 293.000, "Lv", "Livermorium", 7, 16, "", None)
    universe.MakeElement(116, 293.000, "Lv", "Livermorium", 7, 16, "")

    # elt = Element(117, 294.000, "Ts", "Tennessine", 7, 17, "", None)
    universe.MakeElement(117, 294.000, "Ts", "Tennessine", 7, 17, "")

    # elt = Element(118, 294.000, "Og", "Oganesson", 7, 18, "", None)
    universe.MakeElement(118, 294.000, "Og", "Oganesson", 7, 18, "")
